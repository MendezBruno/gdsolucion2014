...
namespace FrbaCommerce.Abm_Cliente
{
    public partial class FormAbmModificacionCliente : Form
    {
        ...
        private void dataGridViewModificacionCliente_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewModificacionCliente.Columns[e.ColumnIndex].HeaderText.Equals("Seleccionar"))
            {
                this.Hide();
            ...
            if (dataGridViewModificacionCliente.Columns[e.ColumnIndex].HeaderText.Equals("Eliminar"))
            {
                this.Hide();
