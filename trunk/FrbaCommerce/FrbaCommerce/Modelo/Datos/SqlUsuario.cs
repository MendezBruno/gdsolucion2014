...
namespace FrbaCommerce.Modelo.Datos
{
     public class SqlUsuario
    {
        internal void darAlta(SistemManager cManager,String dni,String tipo)
        {
           ...
           SqlCommand cmd;
           String ComandoInsert = "INSERT INTO Usuario(Usuario_Nombre,Usuario_Cliente_ID) VALUES('" + dni + "', (SELECT Cliente_ID FROM Cliente WHERE Cliente_Tipo_Doc='" + tipo + "' AND Cliente_DNI =" + dni + "))";
